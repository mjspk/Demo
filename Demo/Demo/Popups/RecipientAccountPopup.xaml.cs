...
namespace Demo.Popups
{
    ...
    public partial class RecipientAccountPopup : PopupPage
    {
        private static RecipientAccountPopup popup;
        RecipientAccountViewModel viewModel;
        public RecipientAccountPopup()
        {
            InitializeComponent();
            BindingContext = viewModel= new RecipientAccountViewModel(this);
        }
    ...
    public class RecipientAccountViewModel : BaseViewModel
    {
        public RecipientAccountViewModel(RecipientAccountPopup popup)
        {
