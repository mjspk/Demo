...
namespace Demo.Pages
{
    ...
    {
        AuthorTransferViewModel viewModel;
        public AuthorTransferPage()
        {
            InitializeComponent();
            BindingContext=viewModel=new AuthorTransferViewModel(this);
        }
    ...
    public class AuthorTransferViewModel : BaseViewModel
    {
       
        public AuthorTransferViewModel(Page page)
        {
            Page = page;
